...
\tikzset{flownode/.style={draw,fill=blue!10,align=center,minimum height=0.75cm,rounded corners,text width=3cm}}
...
\begin{tikzpicture}[auto]
    \tikzmath{\w=345;\u=50;\v=80;}
    \coordinate (O) at (0,0);
    \coordinate (A) at ($(O)+(30:1.25)+(330:4.5)$);
    \coordinate (C) at ($(O)+(330:3.125)+(30:2.5)+(90:1.25)$);
    \coordinate (P) at ($(C)+(\w:5)$);
    \draw ($(A)+(150:2)$) coordinate (1) -- ++(30:1.25) -- ++(90:2.5) -- ++(150:1.25) -- ++(210:1.25) -- ++(270:2.5) -- ++(330:1.25) -- ++(90:2.5) -- ++(30:1.25) 
        ($(1)+(90:2.5)$) -- ++(150:1.25)
        ($(1)+(30:1.25)$) -- ++(150:1.25) -- ++(210:1.25);
    \draw (A) coordinate (1) -- ++(30:1.25) -- ++(90:1) -- ++(150:2.625) -- ++(240:1.08) -- ++(270:1) -- ++(330:2) -- ++(90:1) -- ++(150:2) ($(1)+(90:1)$) -- ++(60:1.08)
    ...
    \draw [dashed] (C) -- (P);
    \draw [axis,red] (P) -- ++(\u:1.5) node [below right] {$x^\ast$};
    \draw [axis,green!50!black] (P) -- ++(\v:1.5) node [left] {$y^\ast$};
    \draw [axis,blue] (P) -- ++(\w:1.5) node [below] {$z^\ast$};
    \draw [-triangle 45] (O) -- ++(90:1) node [left] {$\mathbf{k}$};
    \draw [-triangle 45] (P) -- ++(\u:1) node [below right] {$\mathbf{u}$};
    \draw [-triangle 45] (P) -- ++(\v:1) node [left] {$\mathbf{v}$};
    \draw [-triangle 45] (P) -- ++(\w:1) node [below left] {$\mathbf{w}$};
    \node at ($(P)+(\w:2)$) [rotate=\w] {\includegraphics[width=0.5cm]{../eye.png}};
    \node [point,label={270:$\mathbf{p}$},red] at (P) {};
\end{tikzpicture}
