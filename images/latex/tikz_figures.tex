...
%     \draw [axis,red] (\x+180:3) -- (\x:3) node [below] {$x$};
%     \draw [axis,green!50!black] (\y+180:3) -- (\y:3) node [right] {$y$};
%     \draw [axis,blue] (\z+180:1.5) -- (\z:4) node [left] {$z$};
%     \draw [fill=white,opacity=0.5] (0) -- (1) -- (2) -- (3) -- cycle;
%     \draw [fill=white,opacity=0.5] (0) -- (3) -- (7) -- (4) -- cycle;
%     \draw [fill=white,opacity=0.5] (2) -- (3) -- (7) -- (6) -- cycle;
%     \draw [fill=white,opacity=0.5] (0) -- (1) -- (5) -- (4) -- cycle;
...
%     \draw [fill=white,opacity=0.5] (0) -- (1) -- (5) -- (4) -- cycle;
%     \draw [fill=white,opacity=0.5] (1) -- (2) -- (6) -- (5) -- cycle;
%     \draw [fill=blue,opacity=0.5] (4) -- (5) -- (6) -- (7) -- cycle;
% \end{tikzpicture}
...
%     \draw [fill=green!5] (1) -- (2) -- (3) -- (4) -- cycle;
...
%     \draw [fill=green!5,opacity=0.5] (1) -- (2) -- (3) -- (4) -- cycle;
%     \node [point,label=left:$\mathbf{v}_1$] (1) at (1) {};
%     \node [point,label=below right:$\mathbf{v}_2$] (2) at (2) {};
%     \node [point,label=right:$\mathbf{v}_3$] (3) at (3) {};
%     \node [point,label=left:$\mathbf{v}_4$] (4) at (4) {};
...
%         ($(1)+(150:1.25)$) -- ++(30:2) -- ++(330:1.25) 
%         ($(1)+(150:1.25)+(30:2)$) -- ++(90:1);
%     \draw [fill=gray!10,opacity=0.75] (BL) -- ++(330:\sw) -- node [right,pos=0.2] {projection plane} ++(90:\sh) -- ++(150:\sw) -- cycle;
...
%     \draw [axis] (P) -- ++(330:1) node [below right] {$x$};
%     \draw [axis] (P) -- ++(210:1) node [below left] {$z$};
%     \draw [axis] (P) -- ++(90:1) node [above] {$y$};
...
%     \draw [help lines,fill=gray!10] ($(30:2)+(150:2.5)+(270:1.5)$) -- ++(330:5) --  node [pos=0.2,right,black] {projection plane} ++(90:3) -- ++(150:5) -- cycle;
...
%     \draw [dashed] (0,0) -- (3);
%     \draw [dashed] (0,0) -- (4);
%     \draw [axis] (0,0) -- ++(330:1) node [below right] {$x$};
%     \draw [axis] (0,0) -- ++(90:1) node [above] {$y$};
%     \draw [axis] (0,0) -- ++(210:1) node [below left] {$z$};
...
%     \draw [fill=gray!10] ($(0:3)+(225:1)+(270:1)$) -- ++(45:3.5) -- ++(90:3.5) -- ++(225:3.5) -- cycle;
%     \draw [axis] (0,0) -- ++(225:2) node [below] {$x$};
%     \draw [axis] (0,0) -- ++(90:2) node [left] {$y$};
%     \draw [axis] (0:9) -- (180:1.41) node [left] {$z$} ;
...
%     \draw [axis] (0,0) -- ++(330:1) node [below] {$x$};
%     \draw [axis] (0,0) -- ++(90:1) node [left] {$y$};
%     \draw [axis] (30:8) -- (210:1) node [below left] {$z$};
%     \node at (210:2) [rotate=210] {\includegraphics[width=1cm]{../eye.png}};
...
%     \draw [axis] (0,0) -- ++(330:1) node [below] {$x$};
%     \draw [axis] (0,0) -- ++(90:1) node [left] {$y$};
%     \draw [axis] (0,0) -- ++(210:1) node [below] {$z$};
%     \node at (210:2) [rotate=210] {\includegraphics[width=1cm]{../eye.png}};
...
%     \draw [help lines] ($(30:4)+(150:0.2)$) -- ++(210:0.2) -- ++(330:0.4) -- ++(30:0.2);
...
\begin{tikzpicture}	
    ...
    \draw [axis] (\x+180:4) -- (\x:4);
    \draw [axis] (\y+180:4) -- (\y:4);
    \draw [axis] (\z:4) -- (\z+180:4);
    ...
    \draw [axis] (\x:0.5*\w) -- (\x:4) node [below] {$x$};
    \draw [axis] (\y:0.5*\w) -- (\y:4) node [above] {$y$};
    \draw [axis] (\z+180:0.5*\w) -- (\z+180:4) node [below left] {$z$};
