...
```{figure} /images/scanline_example_tables_02.svg
:width: 400px
```
...
```{figure} /images/scanline_example_tables_03.svg
:width: 400px
```
...
```{figure} /images/scanline_example_tables_04.svg
:width: 400px
```

Edges e2 and e3 have $y_{\min} = 4$ so we move these to AET.

```{figure} /images/scanline_example_tables_05.svg
:width: 400px
```

None of the edges in AET have $y_{\max} = 4$ so we fill pixels $(4,4)$, $(5,4)$ and $(8,4)$.
...
```{figure} /images/scanline_example_tables_06.svg
:width: 400px
```
...
```{figure} /images/scanline_example_tables_07.svg
:width: 400px
```

Fill pixels $(3,5)$ to $(5,5)$ and $(7,5)$ and $(8,5)$
...
```{figure} /images/scanline_example_tables_08.svg
:width: 400px
```

None of the edges in ET have $y_{\min} = 5$ but edge  e3 and e4 in AET have $y_{\max} = 5$ so we remove these from AET.

```{figure} /images/scanline_example_tables_09.svg
:width: 400px
```

Fill pixels $(3,6)$ to $(8,6)$.
...
```{figure} /images/scanline_example_tables_10.svg
:width: 400px
```

None of the edges in ET have $y_{\min} = 5$ and none of the edges in AET have $y_{\max} = 5$ so ET and AET are unchanged. Fill pixels $(3,7)$ to $(8,7)$.
