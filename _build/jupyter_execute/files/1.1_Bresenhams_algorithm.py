...
# \begin{align*}
#     E &= -4, \\
#     x &= 0, & E &\geq -\Delta y & \therefore x &= 0 + 1 = 1, & D &= -2 - 6 = -8, \\
#     y &= 0, & E &\leq \Delta x & \therefore y &= 0 + 1 = 1, & D &= -8 + 4 = -4, \\ \\
#     E &= -8, \\
#     x &= 1, & E &< -\Delta y, \\
#     y &= 1, & E &= -8 \leq \Delta x & \therefore y &= 1 + 1 = 2, & D &= -4 + 4 = 0, \\ \\
#     E &= 0, \\
#     x &= 1, & E &\geq -\Delta y & \therefore x &= 1 + 1 = 2, & D &= 0 - 6 = -6, \\
#     y &= 2, & E &\leq \Delta x & \therefore y &= 2 + 1 = 3, & D &= -6 + 4 = -2, \\ \\
#     E &= -4, \\
#     x &= 2, & E &\geq -\Delta y & \therefore x &= 2 + 1 = 3, & D &= -2 - 6 = -8, \\
#     y &= 3, & E &\leq \Delta x & \therefore y &= 3 + 1 = 4, & D &= -8 + 4 = -4, \\ \\
#     E &= -8, \\
#     x &= 3, & E &< -\Delta y, \\
#     y &= 4, & E &\leq \Delta x & \therefore y &= 4 + 1 = 5, & D &= -4 + 4 = 0, \\ \\
#     E &= 0, \\
#     x &= 3, & E &\geq -\Delta y & \therefore x &= 3 + 1 = 4, & D &= 0 - 6 = -6, \\
#     y &= 5, & E &\leq \Delta x & \therefore y &= 5 + 1 = 6, & D &= -6 + 4 = -2, \\ \\
#     x &= 4, \\
#     y &= 6.
# \end{align*}
# 
...
# \begin{align*}
#     E &= 2, \\
#     x &= 6, & E &\geq -\Delta y & \therefore x &= 6 - 1 = 5, & D &= 1 - 3 = -2, \\
#     y &= 1, & E &\leq \Delta x & \therefore y &= 1 + 1 = 2, & D &= -2 + 4 = 2, \\ \\
#     E &= 4, \\
#     x &= 5, & E &\geq -\Delta y & \therefore x &= 5 - 1 = 4, & D &= 2 - 3 = -1, \\
#     y &= 2, & E &\leq \Delta x & \therefore y &= 2 + 1 = 3, & D &= -1 + 4 = 3, \\ \\
#     E &= 6, \\
#     x &= 4, & E &\geq -\Delta y & \therefore x &= 4 - 1 = 3, & D &= 3 - 3 = 0, \\
#     y &= 3, & E &> \Delta x \\ \\
#     E &= 0, \\
#     x &= 3, & E &\geq -\Delta y & \therefore x &= 3 - 1 = 2, \\
#     y &= 3, & E &\leq \Delta x & \therefore y &= 3 + 1 = 4, \\ \\
#     x &= 2, \\
#     y &= 4.
# \end{align*}
# 
