...
# 
# Computer graphics uses points, line and planes to describe virtual environments. Euclid defined these in his works *The Elements* around 300 BCE which is considered the most important mathematical works ever written. It introduced mathematical concepts of Euclidean geometry, mathematical proofs, logic and number theory. 
# 
# ## Points
# 
...
# 
# $$ \mathbf{q} = \mathbf{p}_1 + a (\mathbf{p}_2 - \mathbf{p}_1) + a (\mathbf{p}_3 - \mathbf{p}_2), $$
# 
...
# ```
# 
# In other words, every point on $p$ is obtained by adding some scalar multiples of the vectors $\mathbf{p}_2 - \mathbf{p}_1$ and $\mathbf{p}_3 - \mathbf{p}_2$. Note we needed $\mathbf{p}_2 - \mathbf{p}_1$ and $\mathbf{p}_3 - \mathbf{p}_2$ not to be parallel else we would have only described a line again.
# 
# ## The normal vector
# 
