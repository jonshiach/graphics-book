...
# \end{align*}
# 
# The affects of applying a $\times 2$ super sample antialiasing can be seen in {numref}`aliased-circle-figure` and {numref}`antialiased-circle-figure`. 
# 
# ```{glue:figure} ssaa-plot
# :figwidth: 300px
# :name: antialiased-circle-figure
# 
# Filled circle with and without super sampling antialiasing applied.
# ```
